...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $exception->getStatusCode() ?? 404 }} — Portal Eurotur</title>
    ...
    <body>
        <div class="wrap">
            ...
            <div class="code">{{ $exception->getStatusCode() ?? 404 }}</div>
            <div class="title">Página no encontrada</div>
            <p class="text">
                La dirección que buscaste no existe o fue movida. Revisá el
                menú lateral y volvé al inicio del portal.
            </p>
